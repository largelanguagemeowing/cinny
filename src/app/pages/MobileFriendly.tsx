...
import { DIRECT_PATH, EXPLORE_PATH, HOME_PATH, INBOX_PATH, ROOMS_PATH, SPACE_PATH } from './paths';
...
export function MobileFriendlyClientNav({ children }: MobileFriendlyClientNavProps) {
  ...
  if (
    ...
    !(homeMatch || roomsMatch || directMatch || spaceMatch || exploreMatch || inboxMatch)
  ) {
    return null;
  }
